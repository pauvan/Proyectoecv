...
import { RegistroSaludComponent } from '../registro-salud/registro-salud.component';

@Component({
  selector: 'app-formulario-salud',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './formulario-salud.component.html',
  styleUrl: './formulario-salud.component.css'
})
export class FormularioSaludComponent {
